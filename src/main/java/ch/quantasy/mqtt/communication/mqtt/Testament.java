 ...
 * @author reto
 */
public class Testament extends AMessage {
    @NonNull
    public String willTopic;
    @NonNull
    public byte[] lastWillMessage;
    ...
    public Testament(String willTopic, byte[] lastWillMessage, boolean isLastWillRetained, int lastWillQoS) {
    ...
    public Testament(Testament testament){
        this.willTopic=testament.willTopic;
        this.lastWillMessage=testament.lastWillMessage.clone();
        this.isLastWillRetained=testament.isLastWillRetained;
        this.lastWillQoS=testament.lastWillQoS;
    }
}
